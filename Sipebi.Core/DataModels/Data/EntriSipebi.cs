namespace Sipebi.Core {
	public class EntriSipebi {
		...
		public string daftar_ragam { get; set; }
		public string daftar_kelas { get; set; }
		public string daftar_bahasa { get; set; }
		public string daftar_bidang { get; set; }
		public string jenis_ki { get; set; }
		public string jenis_penyingkat { get; set; }
    public long? punya_makna { get; set; }
	}
}
